...
<head>
    ...
    <title>{{ config('app.name', 'CBT Mandiri PNC') }} - Login</title>
        ...
        <div class="w-full lg:w-1/2 flex justify-center items-center p-6 sm:p-12">
            ...
            <div class="w-full max-w-md bg-white rounded-xl border border-gray-500 p-8 sm:px-10 sm:py-8 relative overflow-hidden">
                ...
                <div class="relative z-10 mb-6 mt-2">
                    <h2 class="text-2xl font-bold text-black tracking-tight mb-1">Masuk Portal</h2>
                    <p class="text-xs font-medium text-black">Silahkan Masuk Dengan Akun Anda</p>
                    <div class="h-[2px] w-200 bg-gradient-to-r from-gray-400 to-transparent mt-2"></div>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="relative z-10">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="relative flex items-center">
                            ...
                            <button type="button" id="togglePassword" class="absolute right-3 text-black hover:text-gray-600 focus:outline-none">
                                <svg id="eyeOpen" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                                <svg id="eyeClosed" class="w-4 h-4 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="flex justify-end mb-6 mt-1">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs font-bold text-black hover:text-gray-700 transition-colors">
                                Lupa Password ?
                            </a>
                        @endif
                    </div>
                    ...
                    <div class="mt-4 bg-[#EAEAEA] rounded-lg py-2.5 text-center text-sm text-gray-700 font-medium">
                        ...
                        <a href="{{ route('register') }}" class="text-[#2B82D4] font-bold hover:underline">Daftar disini</a>
                    </div>
                </form>
